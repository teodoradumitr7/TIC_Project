...
export default {
  ...
  methods: {
    ...
    //adauga inchiriere daca data e corespunzatoare, dupa data curenta si cea de returnare>data livrare start
    //pune in headere de autorizare cu jwt token din local storage
    //apeleaza back si daca se face postarea revine in home
    //altfel arata notificare sa schimbe data ca masina e deja inchiriata sau nu este data bine inserata
    addRental() {
